...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
  ...
  //管理員工資訊所專用
  @Query("SELECT new login.permission.project.classes.model.EmployeeManageResponse("
          + "employee.employee_id, employee.name, employee.email, employee.phoneNumber, "
          ...
          + "JOIN EmpPositionMap empPositionMap ON employee.employee_id"
          + " = empPositionMap.employee_id "  // 加上空格
